...
<template>
       <div
              class="lg-sidebar gap-y-2 overflow-y-auto px-6 pt-4 border-r border-solid lg:w-72 lg:inset-y-0 lg:fixed hidden sm:flex sm:flex-col lg:flex items-center transition-all duration-300 ease-in-out"
